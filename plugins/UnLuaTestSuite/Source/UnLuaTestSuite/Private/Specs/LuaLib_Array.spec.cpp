...
BEGIN_DEFINE_SPEC(FUnLuaLibArraySpec, "UnLua.API.TArray", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext)
...
void FUnLuaLibArraySpec::Define()
{
    ...
    Describe(TEXT("构造TArray"), [this]
    {
        ...
        It(TEXT("构造TArray<FString>"), EAsyncExecution::TaskGraphMainThread, [this]
        {
            ...
            TEST_EQUAL(Array.Num(), 2);
            TEST_EQUAL(Array[0], TEXT("A"));
            TEST_EQUAL(Array[1], TEXT("B"));
        });
