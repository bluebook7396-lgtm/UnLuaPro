...
BEGIN_DEFINE_SPEC(FUnLuaLibFIntVectorSpec, "UnLua.API.FIntVector", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext)
    lua_State* L;
