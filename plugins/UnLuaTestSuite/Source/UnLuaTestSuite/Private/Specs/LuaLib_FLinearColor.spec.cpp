...
BEGIN_DEFINE_SPEC(FUnLuaLibFLinearColorSpec, "UnLua.API.FLinearColor", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext)
    lua_State* L;
...
void FUnLuaLibFLinearColorSpec::Define()
{
    ...
    Describe(TEXT("tostring()"), [this]
    {
        It(TEXT("转为字符串"), EAsyncExecution::TaskGraphMainThread, [this]()
        {
            ...
            TEST_EQUAL(FString(lua_tostring(L, -1)), TEXT("(R=1.000000,G=2.000000,B=3.000000,A=4.000000)"));
        });
    });
