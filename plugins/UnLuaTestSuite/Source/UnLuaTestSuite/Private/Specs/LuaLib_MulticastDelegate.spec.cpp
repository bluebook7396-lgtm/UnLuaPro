...
BEGIN_DEFINE_SPEC(FUnLuaLibMulticastDelegateSpec, "UnLua.API.FMulticastScriptDelegate", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext)
    lua_State* L;
    UUnLuaTestStub* Stub;
