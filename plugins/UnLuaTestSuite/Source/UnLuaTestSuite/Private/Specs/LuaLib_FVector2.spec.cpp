...
BEGIN_DEFINE_SPEC(FUnLuaLibFVector2DSpec, "UnLua.API.FVector2D", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext)
