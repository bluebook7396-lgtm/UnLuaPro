...
BEGIN_DEFINE_SPEC(FUnLuaLibEKeySpec, "UnLua.API.EKeys", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext)
    lua_State* L;
...
void FUnLuaLibEKeySpec::Define()
{
    ...
    Describe(TEXT("访问EKeys"), [this]()
    {
        It(TEXT("F1"), EAsyncExecution::TaskGraphMainThread, [this]()
        {
            ...
            TEST_EQUAL(FString(lua_tostring(L, -1)), TEXT("F1"));
        });
    });
